...
public class DriveToEncoderDistance extends Command implements PIDOutput, PIDSource {
    ...
    public DriveToEncoderDistance(Encoder encoder, double heading) {
    ...
    public DriveToEncoderDistance(Encoder encoder, double heading, double target, double p, double i, double d, double tolerance) {
    	super("DriveToEncoderDistance");
        requires(Robot.mecanumDrive);
    ...
    public DriveToEncoderDistance(Encoder encoder, double heading, double target, double p, double i, double d, double tolerance, double minSpeed, double maxSpeed, double minInput, double maxInput) {
    	super("DriveToEncoderDistance");
        requires(Robot.mecanumDrive);
    ...
    protected void initialize() {
    	...
    	if(useSmartDashBoardValues) {
    		heading = SmartDashboard.getNumber("DriveEnc Heading", 0.0);
