...
public class AutoMiddleGear extends CommandGroup {
    ...
    public AutoMiddleGear() {
    	...
    	addSequential(new DriveToEncoderDistance(Robot.mecanumDrive.getEncoderLeftFront(), 0, -450, 0.007, 0, 0, 20, 0.2, 1.0, -10000, 10000), 3.0);
    	addSequential(new YawPID(-92, 0.007, 0, 0, 3.0, 0.2), 2.5);
    	...
    	//if(Robot.getSetForTesting()){
	    	...
	    	addSequential(new DriveToUltrasonicDistanceX(new String[] { "rangeGearLeft", "rangeGearRight" }, 3.75, 0.038, 0.00001, 0.0, 0.75, 0.3), 2.0);
	    
	    	addSequential(new Delay(100));
	    	
	    	addSequential(new DriveToUltrasonicDistanceX(new String[] { "rangeGearLeft", "rangeGearRight" }, 24.0, 0.025, 0.00001, 0.0, 1.0, 0.3), 3.3);
    	//}
