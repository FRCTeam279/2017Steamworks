...
public class AutoLeftGear extends CommandGroup {
    ...
    public AutoLeftGear() {
    	...
    	if(Robot.getSetForTesting()){
	    	...
	    	addSequential(new SquareToUltrasonics("rangeGearLeft", "rangeGearRight", 14.0, 0.01, 0.0001, 0.0, 0.5, 0.25), 3.0);
	    	
	    	addSequential(new OpenGearDoor(), 1.5);
	    	
	    	addSequential(new DriveToUltrasonicDistanceX(new String[] { "rangeGearLeft", "rangeGearRight" }, 4.0, 0.01, 0.0001, 0.0, 0.5, 0.3), 4.0);
	    	
	    	addSequential(new DriveToUltrasonicDistanceX(new String[] { "rangeGearLeft", "rangeGearRight" }, 24.0, 0.01, 0.0001, 0.0, 0.5, 0.3), 4.0);
    	}
